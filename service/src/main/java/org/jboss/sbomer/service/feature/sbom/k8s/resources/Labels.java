...
public class Labels {
    ...
    public static final String LABEL_OPERATION_ID = "sbomer.jboss.org/operation-id";
    ...
    public static Map<String, String> defaultLabelsToMap(SbomGenerationType sbomGenerationType) {
