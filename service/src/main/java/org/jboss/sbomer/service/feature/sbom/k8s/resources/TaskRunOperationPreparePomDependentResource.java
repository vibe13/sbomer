...
@KubernetesDependent(resourceDiscriminator = OperationPrepareResourceDiscriminator.class)
@Slf4j
public class TaskRunOperationPreparePomDependentResource extends KubernetesDependentResource<TaskRun, GenerationRequest>
    ...
    public static final String RESULT_NAME = "deliverable-pom";
    ...
    TaskRunOperationPreparePomDependentResource() {
        super(TaskRun.class);
    }

    public TaskRunOperationPreparePomDependentResource(Class<TaskRun> resourceType) {
        super(TaskRun.class);
    }
    ...
    private TaskRun desired(
        ...
        log.debug(
                ...
                SbomGenerationPhase.OPERATIONPREPARE,
        ...
        labels.put(Labels.LABEL_PHASE, SbomGenerationPhase.OPERATIONPREPARE.name().toLowerCase());
        ...
        return new TaskRunBuilder().withNewMetadata()
                ...
                .withParams(
                        ...
                        new ParamBuilder().withName(PARAM_COMMAND_DELIVERABLE_INDEX_NAME)
                                ...
                                .build())
                .withTaskRef(new TaskRefBuilder().withName("sbomer-prepare-pom").build())
                .withWorkspaces(
    ...
    private String resourceName(GenerationRequest generationRequest, int index) {
        return generationRequest.dependentResourceName(SbomGenerationPhase.OPERATIONPREPARE) + "-" + index;
    }
        ...
        return context.getSecondaryResources(TaskRun.class)
                ...
                .filter(
                        tr -> tr.getMetadata()
                                .getName()
                                .startsWith(
                                        generationRequest.dependentResourceName(SbomGenerationPhase.OPERATIONPREPARE)
                                                + "-"))
                .collect(
                        Collectors.toMap(
                                tr -> tr.getMetadata()
