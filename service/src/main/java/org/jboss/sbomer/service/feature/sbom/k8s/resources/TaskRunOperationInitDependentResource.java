        ...
        return new TaskRunBuilder().withNewMetadata()
                ...
                .withParams(
                        new ParamBuilder().withName(PARAM_OPERATION_ID_NAME)
                                .withNewValue(generationRequest.getOperationId())
                                .build(),
                        new ParamBuilder().withName(PARAM_OPERATION_CONFIG_NAME)
                                .withNewValue(generationRequest.getOperationConfig())
                                .build())
                .withTaskRef(new TaskRefBuilder().withName("sbomer-operation-init").build())
                .endSpec()
                .build();
